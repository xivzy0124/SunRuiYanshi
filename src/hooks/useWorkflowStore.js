    ...
    setTimeout(() => {
      const workflow = {
        nodes: [
          ...
          { id: 'map-pressure', type: 'transform', label: '压力字段映射', x: 600, y: 200 },
          { id: 'map-posture', type: 'transform', label: '姿态字段映射', x: 600, y: 400 },
...
function generateNodesFromTemplate(template) {
  ...
  if (template.id === 'fusion-pipeline') {
    return [
      ...
      { id: 'map-1', type: 'transform', label: '压力映射', x: 500, y: 150 },
      { id: 'map-2', type: 'transform', label: '姿态映射', x: 500, y: 350 },
