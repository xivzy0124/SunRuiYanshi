...
const EDGES = [
  ...
  {
    from: 'calc:o:head_forward_angle',
    to: 'join:merged:calc_fields',
    color: C.accent2,
    label: 'carry',
    transformType: 'carry',
  ...
  {
    from: 'join:merged:calc_fields',
    to: 'out:db:t_fusion_health_dataset',
    color: C.green,
    label: 'all 9 fields persisted',
    transformType: 'output',
  },
];
