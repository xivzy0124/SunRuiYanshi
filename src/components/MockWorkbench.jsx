...
const STANDING_LANDMARKS = {
  ...
  left_shoulder: [0.435, 0.215, -0.06],
  right_shoulder: [0.565, 0.215, -0.06],
  left_elbow: [0.418, 0.345, -0.08],
  right_elbow: [0.582, 0.345, -0.08],
  left_wrist: [0.42, 0.475, -0.1],
  right_wrist: [0.58, 0.475, -0.1],
  left_pinky: [0.414, 0.49, -0.1],
  right_pinky: [0.586, 0.49, -0.1],
  left_index: [0.418, 0.49, -0.1],
  right_index: [0.582, 0.49, -0.1],
  left_thumb: [0.428, 0.475, -0.1],
  right_thumb: [0.572, 0.475, -0.1],
  left_hip: [0.458, 0.485, -0.02],
  right_hip: [0.542, 0.485, -0.02],
  left_knee: [0.47, 0.66, 0.01],
  right_knee: [0.53, 0.66, 0.01],
  left_ankle: [0.476, 0.85, 0.02],
  right_ankle: [0.524, 0.85, 0.02],
  left_heel: [0.474, 0.87, 0.03],
  right_heel: [0.526, 0.87, 0.03],
  left_foot_index: [0.466, 0.885, 0.01],
  right_foot_index: [0.534, 0.885, 0.01],
};
